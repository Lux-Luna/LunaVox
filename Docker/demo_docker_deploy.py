"""
Start the API Server using lunavox.start_server(host=SERVER_HOST, port=SERVER_PORT, workers=1).

Quick Reference for LunaVox TTS Server API
...
def run_server():
    lunavox.start_server(host=SERVER_HOST, port=SERVER_PORT, workers=1)
