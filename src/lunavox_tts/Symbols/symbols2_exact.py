# Exact replica of GPT-SoVITS GPT_SoVITS/text/symbols2.py
...
yue_symbols = set()  # keep present per GPT file order; exact content omitted for brevity
...
symbols_v2_exact = symbols
symbol_to_id_v2_exact = {s: i for i, s in enumerate(symbols_v2_exact)}
