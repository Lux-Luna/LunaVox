...
class Qwen3TTSConverter:
    ...
    def _init_ggml_quant_lib(self) -> None:
        ...
        env_path = os.environ.get("LUNAVOX_GGML_BASE_LIB", "").strip()
        if not env_path:
        ...
        candidates.append(repo_root / "ggml" / "build" / "bin" / ggml_lib)
        ...
        raise RuntimeError(
            ...
            "Place ggml-base runtime in ./lib, or set LUNAVOX_LIB_DIR (recommended), "
            "or set LUNAVOX_GGML_BASE_LIB to an explicit ggml-base library file."
